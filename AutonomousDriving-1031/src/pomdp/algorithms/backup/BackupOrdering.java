...
public abstract class BackupOrdering {
	...
	public void improveValueFunctionSinglePassDownToTop(BeliefStateVector<BeliefState> vBeliefPoints){
		
		AlphaVector avBackup = null;
		BeliefState bsCurrent = null;
		Iterator<BeliefState> itCurrentIterationPoints = vBeliefPoints.getTreeDownUpIterator();
		while ( itCurrentIterationPoints.hasNext())
		{
			bsCurrent = (BeliefState) itCurrentIterationPoints.next();
